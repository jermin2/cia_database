...
<head>
	...
	<link rel = "stylesheet" type = "text/css" href = "<?php echo asset_url(); ?>css/bootstrap.min.css?version=1"> 
	<script type = 'text/javascript' src = "<?php echo asset_url(); ?>js/sample.js"></script> 
